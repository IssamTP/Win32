...
namespace FW
{
    ...
    /// <summary>
    /// Enumerazioni delle spie di attivazione funzionalità scroll.
    /// </summary>
    enum class ScrollInfoFlags
    {
        ...
        SIFDisableNoScroll = SIF_DISABLENOSCROLL,
        ...
        SIFPos = SIF_POS,
        /// <summary>The nMinand nMax members contain the minimumand maximum values for the scrolling range.</summary>
        SIFRange = SIF_RANGE,
        /// <summary>The nTrackPos member contains the current position of the scroll box while the user is dragging it.</summary>
        SIFTrackPos = SIF_TRACKPOS,
